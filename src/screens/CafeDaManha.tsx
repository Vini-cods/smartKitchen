...
const KEY_GEMINI = 'AIzaSyBicDb9kMjvCCOU95DJi83ufh4lICah4f8'; // Coloque sua chave
...
export default function CafeDaManha() {
  ...
  async function gerarSugestao() {
    ...
    const prompt = `Sugira uma ideia criativa de café da manhã usando os ingredientes: ${ingrediente1}, ${ingrediente2} e ${ingrediente3}.`;
  ...
  return (
    <View style={estilos.container}>
      <Text style={estilos.header}>Café da Manhã</Text>
      ...
      <TouchableOpacity style={estilos.button} onPress={gerarSugestao}>
        <Text style={estilos.buttonText}>Gerar Sugestão</Text>
      </TouchableOpacity>
...
const estilos = StyleSheet.create({
  ...
  button: { backgroundColor: '#28a745', padding: 14, borderRadius: 6, alignItems: 'center' },
